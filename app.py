...
# ─── Sidebar ────────────────────────────────────────────────────────────────────
with st.sidebar:
    st.markdown('<div class="hero-title" style="font-size:1.6rem">🎬 Video<br>RAG AI</div>', unsafe_allow_html=True)
...
st.markdown('<div class="hero-sub">Transcribe · Summarise · Chat with your meetings/Tutorials</div>', unsafe_allow_html=True)
st.markdown("---")
